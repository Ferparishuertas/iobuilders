...
//
// Copied from https://dzone.com/articles/spring-boot-custom-password-validator-using-passay
//
public class PasswordConstraintValidator implements ConstraintValidator<PasswordConstraint, String> {
	@Override
	public void initialize(final PasswordConstraint arg0) {
	}
	...
	public boolean isValid(String password, ConstraintValidatorContext context) {
		...
		String messageTemplate = messages.stream().sorted().collect(Collectors.joining("|"));
